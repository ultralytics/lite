...
fn deepseek_catalog(app: &AppHandle) -> Option<PathBuf> {
    ...
    for (key, value) in [
        ...
        ("display_name", serde_json::json!("DeepSeek-V4.1-Flash")),
        (
            "description",
            serde_json::json!("DeepSeek V4.1 Flash, served by the DeepSeek API."),
        ),
        ...
        ("input_modalities", serde_json::json!(["text", "image"])),
        ...
        ("supports_image_detail_original", serde_json::json!(true)),
        (
